...
function PricingCard() {
  return (
    <div
      className="p-8 rounded-2xl bg-bg-primary border border-[rgba(0,0,0,0.08)]"
      style={{
        boxShadow:
    ...
    >
      ...
      <div className="mt-6 mb-6 h-px bg-border-secondary" />
      ...
      <div className="mt-10 mb-8 h-px bg-border-secondary" />

      <Button className="w-full py-3">搶先卡位</Button>
    </div>
  );
}
