...
export const loader = async ({ params }: LoaderFunctionArgs) => {
  ...
  const paper = await loadExamMeta("gsat", slug);
  const paperUrl = getAssetUrl("gsat", slug, paper.assets.paper);
  const solutionUrl = paper.assets.solution
    ? getAssetUrl("gsat", slug, paper.assets.solution)
    : null;

  return { paper, paperUrl, solutionUrl };
};

export default function GsatDetailPage() {
    ...
    <div className="flex flex-col h-screen bg-stone-50">
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 pb-12">
          {!revealed ? (
            /* Sealed State — the dramatic reveal trigger */
            ...
            /* Revealed State — answers unlocked */
